...
GitHub Actions がS/Aソースを毎日 04:17（日本時間）に実行し、Bソースを毎週日曜 05:00（日本時間）に216時間の重なりを持たせて確認します。バックフィル版の初回は、イノベーション政策を過去365日、8技術を過去183日まで調べます。サイトにも同じ期間を保持します。完了後の日次実行は直近96時間を確認します。
